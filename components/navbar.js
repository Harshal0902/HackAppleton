...
export default function Navbar() {
    ...
    return (
        <div>
            <nav className="flex items-center py-2 flex-wrap px-4 tracking-wider">
                <Link href="/" passHref><span className="p-2 mr-4 inline-flex items-center text-4xl md:text-5xl cursor-pointer font-base text-white">Space Ore Stuff Inc.
                </span></Link>
                                ...
                                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-gray-900 outline-none focus:outline-none text-white">
                                    ...
                                    >
                                        ...
                                        <Link href="/laser_mining_drill" passHref>
                                            <span className="lg:inline-flex px-3 mx-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-white">Laser Mining Drill</span>
                                        </Link>

                                        <Link href="/mining_base" passHref>
                                            <span className="lg:inline-flex px-3 mx-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-white">Mining Base</span>
                                        </Link>

                                        <Link href="/processing_rig" passHref>
                                            <span className="lg:inline-flex px-3 mx-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-white">Processing Rig</span>
                                        </Link>
                ...
                <div className="hidden top-navbar w-full lg:inline-flex lg:flex-grow lg:w-auto" >
                    <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full text-xl lg:items-center items-start flex flex-col lg:h-auto space-x-2 mr-12" >
                        ...
                        <Link href="/laser_mining_drill" passHref>
                            <span className="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-white">Laser Mining Drill</span>
                        </Link>

                        <Link href="/mining_base" passHref>
                            <span className="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded items-center justify-center dark:hover:bg-navHover hover:bg-secondary cursor-pointer text-white">Mining Base</span>
                        </Link>
